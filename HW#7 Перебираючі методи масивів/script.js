...
function getMedian(...numbers) {
  ...
  if (numbers.length % 2) {
    ...
    const result = (numbers[resultLeft] + numbers[resultRigth]) / 2;
...
console.log(
  "Кількість чисел більших за нуль:",
  countPositiveNumbers(...numberArray6)
);
...
console.log(
  "Числа, які діляться націло на 5:",
  getDividedByFive(...numberArray7)
);
...
console.log("Розбиває на склади:", chunkStr("Commander America", 3, []));
